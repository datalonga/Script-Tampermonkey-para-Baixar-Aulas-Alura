...
// @version      1.7
// @description  Detecta a melhor qualidade (FullHD/HD), captura links (gnarus/video2), baixa vídeos e gera lista de aulas (apenas vídeos) em TXT sem cabeçalho.
// @author       Você
...
(function() {
    ...
    // --- FUNÇÃO ATUALIZADA: Gerar e Baixar TXT (Apenas Vídeos, Sem Cabeçalho) ---
    function generateAndDownloadTxt() {
        ...
        // Cabeçalho removido conforme pedido. Conteúdo inicia vazio.
        let textContent = "";
