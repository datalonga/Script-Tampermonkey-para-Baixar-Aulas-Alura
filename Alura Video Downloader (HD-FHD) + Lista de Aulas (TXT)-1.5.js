...
// @version      1.5
// @description  Detecta a melhor qualidade (FullHD/HD), captura links (gnarus/video2), baixa vídeos e gera lista de aulas em TXT.
// @author       Você
...
(function() {
    ...
    // --- FUNÇÃO NOVA: Gerar e Baixar TXT ---
    function generateAndDownloadTxt() {
        ...
        let textContent = "Lista de Aulas - Alura\n\n";
